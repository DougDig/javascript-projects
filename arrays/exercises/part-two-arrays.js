...
let sacrificialArray = cargoHold
console.log(` The Array is ${sacrificialArray.length} characters long, it's members are, ${sacrificialArray.shift()}, ${sacrificialArray.shift()}, ${sacrificialArray.shift()}, ${sacrificialArray.shift()}, ${sacrificialArray.shift()}, ${sacrificialArray.shift()}, ${sacrificialArray.shift()} amazing!`)